...
public class IComponent {
    ...
    public void decodeScriptsFormat(InputStream stream) {
        ...
        System.out.println("useScripts = "+useScripts);
        ...
        System.out.println("aString2357 = "+aString2357);
        System.out.println("aString2391 = "+aString2391);
        for (int i = 0; i < aStringArray2385.length; i++) {
            System.out.println("aStringArray2385["+i+"] = "+aStringArray2385[i]);
        }
        for (int i = 0; i < anIntArray2315.length; i++) {
            System.out.println("anIntArray2315["+i+"] = "+anIntArray2315[i]);
        }
        System.out.println("aString2330 = "+aString2330);
        System.out.println("aBoolean2436 = "+aBoolean2436);
        System.out.println("aString2463 = "+aString2463);
        System.out.println("anInt2303 = "+anInt2303);
        System.out.println("anInt2364 = "+anInt2364);
        for (int i = 0; i < anObjectArray2462.length; i++) {
            System.out.println("anObjectArray2462["+i+"] = "+anObjectArray2462[i]);
        }
        for (int i = 0; i < anObjectArray2402.length; i++) {
            System.out.println("anObjectArray2402["+i+"] = "+anObjectArray2402[i]);
        }
        for (int i = 0; i < anObjectArray2371.length; i++) {
            System.out.println("anObjectArray2371["+i+"] = "+anObjectArray2371[i]);
        }
        for (int i = 0; i < anObjectArray2408.length; i++) {
            System.out.println("anObjectArray2408["+i+"] = "+anObjectArray2408[i]);
        }
        for (int i = 0; i < anObjectArray2439.length; i++) {
            System.out.println("anObjectArray2439["+i+"] = "+anObjectArray2439[i]);
        }
        for (int i = 0; i < anObjectArray2454.length; i++) {
            System.out.println("anObjectArray2454["+i+"] = "+anObjectArray2454[i]);
        }
        for (int i = 0; i < anObjectArray2410.length; i++) {
            System.out.println("anObjectArray2410["+i+"] = "+anObjectArray2410[i]);
        }
        for (int i = 0; i < anObjectArray2316.length; i++) {
            System.out.println("anObjectArray2316["+i+"] = "+anObjectArray2316[i]);
        }
        for (int i = 0; i < anObjectArray2465.length; i++) {
            System.out.println("anObjectArray2465["+i+"] = "+anObjectArray2465[i]);
        }
        for (int i = 0; i < anObjectArray2446.length; i++) {
            System.out.println("anObjectArray2446["+i+"] = "+anObjectArray2446[i]);
        }
        for (int i = 0; i < anObjectArray2313.length; i++) {
            System.out.println("anObjectArray2313["+i+"] = "+anObjectArray2313[i]);
        }
        for (int i = 0; i < anObjectArray2318.length; i++) {
            System.out.println("anObjectArray2318["+i+"] = "+anObjectArray2318[i]);
        }
        for (int i = 0; i < anObjectArray2328.length; i++) {
            System.out.println("anObjectArray2328["+i+"] = "+anObjectArray2328[i]);
        }
        for (int i = 0; i < anObjectArray2395.length; i++) {
            System.out.println("anObjectArray2395["+i+"] = "+anObjectArray2395[i]);
        }
        for (int i = 0; i < anObjectArray2331.length; i++) {
            System.out.println("anObjectArray2331["+i+"] = "+anObjectArray2331[i]);
        }
        for (int i = 0; i < anObjectArray2405.length; i++) {
            System.out.println("anObjectArray2405["+i+"] = "+anObjectArray2405[i]);
        }
        for (int i = 0; i < anObjectArray2351.length; i++) {
            System.out.println("anObjectArray2351["+i+"] = "+anObjectArray2351[i]);
        }
        for (int i = 0; i < anObjectArray2302.length; i++) {
            System.out.println("anObjectArray2302["+i+"] = "+anObjectArray2302[i]);
        }
        for (int i = 0; i < anObjectArray2296.length; i++) {
            System.out.println("anObjectArray2296["+i+"] = "+anObjectArray2296[i]);
        }
        for (int i = 0; i < anIntArray2452.length; i++) {
            System.out.println("anIntArray2452["+i+"] = "+anIntArray2452[i]);
        }
        for (int i = 0; i < anIntArray2472.length; i++) {
            System.out.println("anIntArray2472["+i+"] = "+anIntArray2472[i]);
        }
        for (int i = 0; i < anIntArray2360.length; i++) {
            System.out.println("anIntArray2360["+i+"] = "+anIntArray2360[i]);
        }
        for (int i = 0; i < anIntArray2388.length; i++) {
            System.out.println("anIntArray2388["+i+"] = "+anIntArray2388[i]);
        }
        for (int i = 0; i < anIntArray2299.length; i++) {
            System.out.println("anIntArray2299["+i+"] = "+anIntArray2299[i]);
        }
    }
    ...
    public Object[] decodeScript(InputStream stream) {
        ...
        for (int index = 0; (size ^ 0xffffffff) < (index ^ 0xffffffff);
                index++) {
    ...
    public void decodeNoscriptsFormat(InputStream stream) {
        ...
        if ((i_1_ ^ 0xffffffff) < -1) {
            ...
            for (int i_2_ = 0;
                ...
                for (int i_4_ = 0;
                        ...
                        i_4_++) {
                    anIntArrayArray2327[i_2_][i_4_] = stream.readUnsignedShort();
        ...
        System.out.println("anInt2324 = "+anInt2324);
        System.out.println("anInt2441 = "+anInt2441);
        System.out.println("x = "+x);
        System.out.println("y = "+y);
        System.out.println("width = "+width);
        System.out.println("height = "+height);
        System.out.println("anInt2369 = "+anInt2369);
        System.out.println("parentId = "+parentId);
        System.out.println("anInt2448 = "+anInt2448);
        for (int is = 0; is < anIntArray2407.length; i++) {
            System.out.println("anIntArray2407["+is+"] = "+anIntArray2407[is]);
        }
        for (int is = 0; is < aStringArray2363.length; i++) {
            System.out.println("aStringArray2363["+is+"] = "+aStringArray2363[is]);
        }
    }
