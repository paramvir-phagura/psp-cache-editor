	...
	public static void main(String[] args) throws IOException {
		...
		for(int i = 4139; i <= 4146; i++) {
			result = cache.getIndexes()[8].putFile(i, 0,  Constants.GZIP_COMPRESSION,
					new IndexedColorImageFile(ImageIO.read(new File("718/sprites/bg/"+i+".gif"))).encodeFile()
					, null, false, false, -1, -1);
		}
		System.out.println("Added matrix background: "+result);
		...
		System.out.println("Added matrix load background: "+result);
