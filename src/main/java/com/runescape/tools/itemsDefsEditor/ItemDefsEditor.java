package com.runescape.tools.itemsDefsEditor;
...
import com.runescape.loaders.items.ItemDefinitions;
...
public class ItemDefsEditor extends JDialog {
	...
	public void save() {
		...
		defs.maleEquip1 = Integer.valueOf(maleModelId1Field.getText());
		defs.maleEquip2 = Integer.valueOf(maleModelId2Field.getText());
		defs.colourEquip1 = Integer.valueOf(maleModelId3Field.getText());

		defs.femaleEquip1 = Integer.valueOf(femaleModelId1Field.getText());
		defs.femaleEquip2 = Integer.valueOf(femaleModelId2Field.getText());
		defs.colourEquip2 = Integer.valueOf(femaleModelId3Field.getText());
		defs.team = Integer.valueOf(teamIdField.getText());

		//others
		defs.certTemplate = Integer.valueOf(notedItemIdField.getText());
		defs.certLink = Integer.valueOf(switchNotedItemField.getText());
		defs.lentTemplate = Integer.valueOf(lendedItemIdField.getText());
		defs.lentLink = Integer.valueOf(switchLendedItemField.getText());
		...
		defs.members = membersOnlyCheck.isSelected();
	...
	public ItemDefsEditor(Application application, ItemDefinitions defs) {
		...
		femaleModelId2Field.setText(""+defs.femaleEquip2);
		...
		maleModelId1Field.setText(""+defs.maleEquip1);
		{
			...
			maleModelId2Field.setText(""+defs.maleEquip2);
		}
		{
			...
			maleModelId3Field.setText(""+defs.colourEquip1);
		}
		{
			...
			femaleModelId1Field.setText(""+defs.femaleEquip1);
		}
		{
			...
			femaleModelId3Field.setText(""+defs.colourEquip2);
		}
		{
		...
		}
		{
			...
			notedItemIdField.setText(""+defs.certTemplate);
		}
		{
			...
			switchNotedItemField.setText(""+defs.certLink);
		}
		{
			...
			lendedItemIdField.setText(""+defs.lentTemplate);
		}
		{
			...
			switchLendedItemField.setText(""+defs.lentLink);
		}
		{
		...
		membersOnlyCheck.setSelected(defs.members);
