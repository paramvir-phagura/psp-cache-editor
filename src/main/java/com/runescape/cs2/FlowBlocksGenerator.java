package com.runescape.cs2;

import com.runescape.cs2.ast.*;
import com.runescape.cs2.instructions.*;
import com.runescape.cs2.util.FunctionInfo;
import com.runescape.cs2.util.IOUtils;
import com.runescape.cs2.util.OpcodeUtils;
...
//                    break;
                    ...
                    if (Opcodes.isAssign(opcode)) {
                        ...
                        do {
                            ...
                            if (opcode == Opcodes.POP_INT || opcode == Opcodes.POP_STRING || opcode == Opcodes.POP_LONG) {
                                var = opcode == Opcodes.POP_INT ? Underscore.UNDERSCORE_I : opcode == Opcodes.POP_STRING ? Underscore.UNDERSCORE_S : Underscore.UNDERSCORE_L;
                            ...
                            } else if (opcode == Opcodes.STORE_VARCSTR) {
